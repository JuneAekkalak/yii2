...
class PersonalInfo extends \yii\mongodb\ActiveRecord
{
    ...
    {
        return [
            [['image_url', 'firstname', 'lastname', 'nickname', 'age', 'dob', 'gender', 'high_school_name', 'graduation', 'cllege_name', 'majors', 'school_of', 'color', 'food', 'sport', 'com_langs', 'database', 'course', 'langs', 'facebook', 'line', 'instragram', 'e_mail', 'phone'], 'safe']
        ];
    }
