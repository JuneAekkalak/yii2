...
class PersonalInfoSearch extends PersonalInfo
{
    ...
    {
        return [
            [['_id', 'image_url', 'firstname', 'lastname', 'nickname', 'age', 'dob', 'gender', 'high_school_name', 'graduation', 'cllege_name', 'majors', 'school_of', 'color', 'food', 'sport', 'com_langs', 'database', 'course', 'langs', 'facebook', 'line', 'instragram', 'e_mail', 'phone'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', '_id', $this->_id])
            ...
            ->andFilterWhere(['like', 'cllege_name', $this->cllege_name])
